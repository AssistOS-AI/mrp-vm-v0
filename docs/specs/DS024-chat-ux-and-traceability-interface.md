...
11. a default width strategy that distributes available viewport width evenly across layers while respecting content-based minimum and maximum bounds, so the graph fills horizontal space without unnecessary scrolling,
